...
rem xcopy /Y %CurrentPath%\..\..\DDRLocalServer\x64\Debug\*.pdb %CurrentPath%\..\..\www\bin\x64\Debug\ /s /i
rem xcopy /Y %CurrentPath%\..\..\DDRStreamRelayService\x64\Debug\*.pdb %CurrentPath%\..\..\www\bin\x64\Debug\ /s /i
