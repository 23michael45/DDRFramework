...
xcopy /Y %BaseXmlPath%\*.xml %DDR_VirtualService_Project_Path%\Config  /i
...
xcopy /Y %VirtualServiceXmlPath% %DDR_VirtualService_Project_Path%\Config\VirtualService /s /i
...
xcopy /Y %DDR_VirtualService_Project_Path%\Config %DDR_LocalServer_Debug_Path%\Config /s /i
xcopy /Y %DDR_VirtualService_Project_Path%\Config %DDR_LocalServer_Release_Path%\Config /s /i
